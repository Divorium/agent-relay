...
const runnerWorkspaceRoot = "/srv/github-runner/storage/work";
const trustedWorkspace = `${runnerWorkspaceRoot}/repository/repository`;
...
test("Codex trust override safely quotes the canonical workspace path", () => {
  const workspace = `${runnerWorkspaceRoot}/repo with "quote"/repo`;
  const args = createCodexArgs(workspace, "prompt", "/home/runner", "/home/runner/runtime", "/srv/source");
